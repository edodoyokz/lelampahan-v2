...
import { CalendarCheck, Compass, X } from 'lucide-react';
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="mt-1 flex flex-wrap gap-3">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium transition-colors bg-lelampahan-gold text-white"
                aria-pressed="true"
              >
                <CalendarCheck className="h-4 w-4" aria-hidden="true" />
